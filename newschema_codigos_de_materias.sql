...
--
-- Table structure for table `codigos_de_materias`
--

DROP TABLE IF EXISTS `codigos_de_materias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `codigos_de_materias` (
  `codigos_de_materias` varchar(20) NOT NULL,
  `nota_asignada` varchar(20) DEFAULT NULL,
  `carrera_asignada_a_nota` int DEFAULT NULL,
  PRIMARY KEY (`codigos_de_materias`),
...
-- Dump completed on 2022-06-03 20:31:26
