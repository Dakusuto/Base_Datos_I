...
CREATE TABLE `materias` (
  ...
  CONSTRAINT `codigo_de_materia` FOREIGN KEY (`codigo_de_materia`) REFERENCES `codigos_de_materias` (`codigos_de_materias`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2022-06-03 20:31:25
